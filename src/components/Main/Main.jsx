    ...
    <div className="main">
      ...
      <div className="main-container">
        ...
        <> 
         ...
         <div className="greet">
          <p>
            <span>Welcome Sagar, how may i help you !!</span>
          </p>
        ...
        :<div className="result">
         ...
         <div className="main-bottom">
            ...
            <p className="bottom-info">
               This may display your message to improve its responses,so double-check its responses.Your privacy and Our Apps.
            </p>
         </div>
      </div>
    </div>
